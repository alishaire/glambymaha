...
const Index = () => {
  return (
    <section className="max-w-[1000px] m-auto mt-10 px-4">
      <div className="text-center max-w-xl mx-auto">
        <h1 className="text-6xl md:text-7xl capitalize font-bold mb-5">
          Privacy Policy
        </h1>
      ...
      <h3 className=" text-2xl font-bold my-2">Interpretation</h3>
      <p>
      ...
      <h3 className=" text-2xl font-bold my-2">Definitions</h3>
      ...
      <ul className=" list-disc my-2 px-4">
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Edify College Of It.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Edify College Of It, accessible
            from{" "}
            <a
              href="http://edifycit.com/"
      ...
      <h4 className=" text-xl font-bold my-1">Personal Data</h4>
      <p>
      ...
      <h4 className=" text-xl font-bold my-1">Usage Data</h4>
      ...
      <h4 className=" text-xl font-bold my-1">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h4 className=" text-xl font-bold my-1">Business Transactions</h4>
      <p>
      ...
      <h4 className=" text-xl font-bold my-1">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className=" text-xl font-bold my-1">Other legal requirements</h4>
      <p>
      ...
      <ul className=" list-disc my-2 px-4">
        <li>
          <p>By email: info@edifycit.com</p>
        </li>
        <li>
          <p>By phone number: +92 321-8886640</p>
        </li>
      </ul>
    </section>
  );
